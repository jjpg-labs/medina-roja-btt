export const race = {
  ...
  sponsors: [
    { name: "Tienda Joseguí y Lola", logo: null,                    url: null },
    { name: "Estanco Antonia",       logo: null,                    url: null },
    { name: "Ciclos Quijote",        logo: null,                    url: null },
    { name: "Pafgio",                logo: null,                    url: null },
    { name: "Panadería Ortíz",       logo: null,                    url: null },
    { name: "X-Sauce",               logo: null,                    url: null },
    { name: "Leña Selas",            logo: null,                    url: null },
    { name: "Baúl Celia",            logo: null,                    url: null },
    { name: "Casino",                logo: null,                    url: null },
    { name: "Toteemi",               logo: "/sponsors/toteemi.png", url: "https://toteemi.com/producto/inscripcion-desafio-medina-roja/" },
    { name: "Ayto. Almedina",        logo: null,                    url: null },
    { name: "Graficas Matamoros",    logo: null,                    url: null },
    { name: "Be fit",                logo: null,                    url: null },
  ] as { name: string; logo: string | null; url: string | null }[],
};
